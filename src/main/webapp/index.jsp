...
<html lang="es">
    ...
    <h1>Hola</h1>
        ...
        <%
            Database.connect();
            List<Camion> camiones = Database.jdbi.withExtension(CamionDao.class, dao -> dao.getAllCamiones());
        ...
        <div class="col">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <p class="card-text"><strong><%= camion.getMatricula() %></strong></p>
                    <p class="card-text"><%= camion.getCapacidad() %></p>
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <small class="text-body-secondary"><%= camion.getEstado() %> €</small>
                    </div>
                </div>
            </div>
        </div>
